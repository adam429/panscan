Opal.queue(function(Opal) {/* Generated by Opal 1.4.1 */
  var self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $eqeq = Opal.eqeq, $send = Opal.send, $gvars = Opal.gvars, $to_a = Opal.to_a, $rb_minus = Opal.rb_minus, $rb_plus = Opal.rb_plus, $lambda = Opal.lambda, $def = Opal.def, $hash2 = Opal.hash2, $truthy = Opal.truthy, $to_ary = Opal.to_ary, $rb_gt = Opal.rb_gt, $neqeq = Opal.neqeq;
  if ($gvars.document == null) $gvars.document = nil;

  Opal.add_stubs('==,[],href=,location,-,+,inner_html=,at_css,call,do_update_page,inner_html,Native,get_params,get_page,get_server_task,update_page,html=,find,get,ok?,json,update_task_run,take_action,[]=,post,each,value,flatten,scan,map,filter,uniq,include?,size,join,split,gsub,!=,>,show,hide,ready,on,do_save,do_run,do_fork,update_params,parse,update_refs,body,meta?,shift?,char,puts,prevent,key');
  ...
  $def(self, '$get_params', function $$get_params() {
    ...
    ret = $hash2([], {});
    $send($gvars.params, 'each', [], function $$10(param){var $writer = nil;
      if ($gvars.document == null) $gvars.document = nil;
