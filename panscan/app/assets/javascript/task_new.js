Opal.queue(function(Opal) {/* Generated by Opal 1.4.1 */
  ...
  Opal.add_stubs('==,[],href=,location,-,+,inner_html=,at_css,call,do_update_page,inner_html,Native,get_params,get_page,get_server_task,update_page,get,on,json,update_task_run,take_action,[]=,post,open,each,value,flatten,scan,map,filter,!=,gsub,>,size,show,hide,join,ready,do_save,do_run,do_fork,update_params,parse,body,meta?,shift?,char,puts,prevent,key');
  ...
  $def(self, '$do_save', function $$do_save() {
    var self = this, window = nil, cmd = nil;
