Opal.queue(function(Opal) {/* Generated by Opal 1.4.1 */
  ...
  Opal.add_stubs('==,[],href=,location,-,+,inner_html=,at_css,call,do_update_page,inner_html,Native,get_params,get_page,get_server_task,update_page,get,on,json,update_task_run,take_action,[]=,post,each,value,flatten,scan,map,filter,uniq,include?,size,join,split,gsub,!=,>,show,hide,ready,do_save,do_run,do_fork,update_params,parse,update_refs,body,meta?,shift?,char,puts,prevent,key');
