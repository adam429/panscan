Opal.queue(function(Opal) {/* Generated by Opal 1.4.1 */
  ...
  Opal.add_stubs('==,[],href=,location,-,+,inner_html=,at_css,call,do_update_page,inner_html,Native,get_params,get_page,get_server_task,update_page,get,on,json,update_task_run,take_action,[]=,post,each,value,flatten,scan,map,filter,!=,gsub,>,size,show,hide,join,ready,do_save,do_run,do_fork,update_params,parse');
  ...
  return $send($gvars.document, 'ready', [], function $$18(){var self = $$18.$$s == null ? this : $$18.$$s, init_params = nil, json = nil;
    ...
    return $gvars.$['$[]']("setInterval").$call($lambda(function $$22(){var self = $$22.$$s == null ? this : $$22.$$s;

      return self.$update_params()}, {$$arity: 0, $$s: self}), 1000);}, {$$arity: 0, $$s: self});
});
