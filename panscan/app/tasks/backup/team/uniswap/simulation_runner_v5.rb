__TASK_NAME__ = "team/uniswap/simulation_runner_v5"
...
load(Task.load("team/uniswap/uniswapv3_v2"))
load(Task.load("team/uniswap/cex"))
load(Task.load("team/uniswap/dex_v2"))
load(Task.load("team/uniswap/bot_v2"))
load(Task.load("team/uniswap/simulation_class_v3"))
...
<% if data[:load_action]!="run_simulation_queue" then %>
      ...
      <div id="container">
        <div>
          ...
          [<%= button text:"start simulation frontend", action:"generate_data" %> ] [<%= button text:"start simulation backend", action:"generate_data_backend" %> ]  <br/>
