__TASK_NAME__ = "panbot/online/panbot_online_runner_bot0"
...
class OnlineRunner < PanRunner
    ...
    def initialize()
        ...
        @bot_private_key = Vault.get("bot_private_key")[__bot_id__]
        
        @pan_action = PancakePrediction.new(@gas_premium,@bot_private_key)
...
def main
    ...
    runner._get_current_epoch()
    runner.betBear(self,0.001)
